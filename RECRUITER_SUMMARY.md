...
3. **[03-OmniVision-DocIntel™ API](./README.md)**: Asynchronous FastAPI microservice delivering sub-65ms document AI with Error Level Analysis (ELA) pixel tampering forensics and multimodal VLM extraction.
...
| **AI / Machine Learning / API Engineer** | **[03-OmniVision-DocIntel™ API](./README.md)** | FastAPI, OpenCV (cv2), Pillow, Multimodal VLM, Docker, Prometheus, SSE | **Sub-65ms P95 latency**; ELA compression forensics flags spliced receipt pixels ($Std > 18.0$). |
...
# Launch FastAPI Swagger documentation:
